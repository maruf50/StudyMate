...
async function getAcceptedFriendIds(userId) {
    ...
    return new Set(requests.map((request) => (request.requesterId === userId ? request.addresseeId : request.requesterId)));
}
...
function serializeNote(note, currentUserId, friendIds) {
...
app.get("/api/matches/users", async (req, res) => {
    try {
        void req;
...
app.post("/api/friends/requests/:requestId/reject", async (req, res) => {
    try {
        void req;
        const { requestId } = req.params;
        const userId = await getDemoUserId();
...
app.get("/api/chat/groups/:groupId", async (req, res) => {
    try {
...
app.post("/api/chat/groups/:groupId", async (req, res) => {
    try {
        const userId = await getDemoUserId();
        const { groupId } = req.params;
        const { content } = req.body;
...
// Update Note Privacy
app.put("/api/notes/:noteId/privacy", async (req, res) => {
    try {
...
app.post("/api/notes/:noteId/request-access", async (req, res) => {
    try {
        void req;
        const userId = await getDemoUserId();
        const { noteId } = req.params;
...
app.get("/api/notes/:noteId/access-requests", async (req, res) => {
    try {
        const { noteId } = req.params;
...
app.post("/api/notes/access-requests/:requestId/approve", async (req, res) => {
    try {
        void req;
        const { requestId } = req.params;
...
app.post("/api/notes/access-requests/:requestId/reject", async (req, res) => {
    try {
        void req;
        const { requestId } = req.params;
        const updatedRequest = await prisma.noteAccessRequest.update({
